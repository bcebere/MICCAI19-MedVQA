...
class SimpleCNN(nn.Module):
    def __init__(
        self, weight_path="simple_cnn.weights", eps_cnn=1e-5, momentum_cnn=0.05
    ):
        ...
        self.conv1_bn = nn.BatchNorm2d(
            num_features=64, eps=eps_cnn, affine=True, momentum=momentum_cnn
        )
...
if __name__ == "__main__":
    simple_cnn = SimpleCNN(
        weight_path="simple_cnn.weights", eps_cnn=1e-5, momentum_cnn=0.05
    )
